      ...
      <div className="container flex items-center justify-between h-16 md:h-20">
        ...
        <a href="#" className="flex items-center gap-2">
          ...
          <div className="text-white leading-tight">
            <span className="block font-black text-base tracking-widest uppercase">Good Dog</span>
            <span className="block text-[9px] tracking-[0.22em] uppercase font-light opacity-80">Adiestramiento Canino · Asturias</span>
          </div>
        </a>
