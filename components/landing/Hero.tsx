...
const slides = [
  {
    ...
    headline1: "GOOD DOG",
    headline2: "ADIESTRAMIENTO CANINO · ASTURIAS",
    body: "Educación canina con métodos positivos y respetuosos en plena naturaleza asturiana. Ayudamos a entender y mejorar la conducta de tu perro en un entorno rural tranquilo, adaptado a todos los niveles.",
  },
  {
  ...
  },
  {
    ...
    headline2: "EN GOOGLE · ALLENDE, ASTURIAS",
    body: "Nuestros clientes nos avalan con una valoración excelente. Sesiones guiadas por profesionales del adiestramiento en el entorno natural privilegiado de Asturias.",
  },
];
